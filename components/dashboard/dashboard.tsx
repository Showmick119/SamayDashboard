...
const API_BASE_URL = process.env.NEXT_PUBLIC_API_BASE_URL || "https://570f-130-207-126-160.ngrok-free.app"
...
export default function Dashboard() {
  ...
  const generatePlot = async () => {
    ...
    try {
      const response = await fetch(`${API_BASE_URL}/run_inference`, {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({ model_name: selectedModel, dataset_name: "uploaded" }),
      })
